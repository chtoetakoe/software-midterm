  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="flex justify-between mt-6">
        <Button
          variant="destructive"
          onClick={() => handleReview(FlashcardDifficulty.HARD)}
        ...
        <Button
          variant="outline"
          onClick={() => handleReview(FlashcardDifficulty.MEDIUM)}
          className="flex items-center gap-2"
        >
        ...
        <Button
          variant="default"
          onClick={() => handleReview(FlashcardDifficulty.EASY)}
          className="flex items-center gap-2"
        >
          <BadgeCheck size={18} />
          <span>Easy</span>
